<?php
/**
 * class People_Form_UserMy
 *
 * @package     People
 * @subpackage  User My Account
 * @author      Ever Daniel Barreto <e.barreto@amediacreative.com>
 * @link        www.amediacreative.com
 */
class People_Form_UserMy extends Zend_Form
{
	/**
     * Form Init
     *
	...
	public function init()
	{
        ...
        $this->addElement('text', 'ID_user', array(
            ...
            'filters'    => array('StringTrim')
                    ...
                    // Avatar
        $this->addElement('text', 'user_avatar_file', array(
            'label'      => 'user_avatar_file',
            'required'   => false,
            'filters'    => array('StringTrim')
        ));         
